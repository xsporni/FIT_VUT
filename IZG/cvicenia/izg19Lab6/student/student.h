...
/**
 * \mainpage Izg 2017 - 2019, cvičení 6.
 * 
 * \section zadani Zadání cvičení 6. do předmětu IZG 2018 - 2019.
 *
 * \tableofcontents
 *
 *
 ...
 * Tento příklad můžete využít pro inspiraci a návod jak napsat cvičení, musíte však zaměnit některé funkce za tzv. Direct State Access (DSA) alternativy (NUTNÉ POUŽÍVAT MIN. OPENGL 4.5).
 ...
 * Model králička je v souboru <b>student/model.h</b>.
 *
 ...
 * \image html images/64build.png "sestavení v CVT"
